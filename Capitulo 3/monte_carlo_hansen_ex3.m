% Simulación Monte Carlo para la Extensión 3 del modelo RBC
...
dynare rbc_Hansen_ex3.mod noclearall nolog
...
% Guardar resultados
save monte_carlo_ex3_results.mat sigma_y sigma_c_y sigma_i_y sigma_h_y sigma_w_y sigma_h_w corr_hw
...
sgtitle('Simulación Monte Carlo - Extensión 3: Gasto Público', 'FontSize', 13, 'Interpreter', 'latex');

set(gcf, 'PaperUnits', 'inches', 'PaperPosition', [0 0 11 8]);
print(gcf, '6. Histograma_RBC_Hansen_Ex3', '-dpdf');
